...
export default function VocabularyDetailPage({
  ...
  useEffect(() => {
    params.then(({ id }) => {
      setId(id);
      apiGet<VocabularyDetailResponse>(`/api/vocabulary/${id}`)
        .then((data) => {
        ...
        .catch(() => router.replace("/vocabulary"))
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      await apiPatch<VocabularyDetailResponse>(`/api/vocabulary/${id}`, payload);
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="pt-2 flex items-center gap-3">
          ...
          <button
            ...
            className="ml-auto inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-error-subtle text-error text-sm font-medium hover:bg-error/10 transition-colors"
          >
            <Trash2 size={16} />
            Delete
          </button>
